...
class GraphCell {
    ...
    getBounds() {
        ...
        return new coords.BBox(this.x * gp.cellWidth, this.y * gp.cellHeight, gp.cellWidth, gp.cellHeight);
    }
}
class GraphBox {
    constructor(originCell, spanRight, spanDown, graphPaper) {
        ...
        this.graphPaper = graphPaper;
        this.bounds = new coords.BBox(this.originCell.x * graphPaper.cellWidth, this.originCell.y * graphPaper.cellHeight, (this.spanRight - 1) * graphPaper.cellWidth, (this.spanDown - 1) * graphPaper.cellHeight);
    }
}
...
//# sourceMappingURL=GraphPaper.js.map